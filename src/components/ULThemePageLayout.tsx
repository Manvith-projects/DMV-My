      ...
      */}
      ...
      >
        <div className="container mx-auto px-9 relative bg-cover">
          <div className="absolute inset-2 flex items-start justify-start">
            <h1
              className="hero-title m-10 ml-35"
              style={{ fontFamily: "tt-commons-800-italic, sans-serif" }}
            >
              {String(
                (rest as Record<string, unknown>)["data-page-title"] ??
                  (rest as Record<string, unknown>)["data-hero-title"] ??
                  "LOG IN"
              )}
            </h1>
          </div>
      ...
      <div
        ...
        style={{
          marginTop: "-220px", // negative margin to lift content over the hero
          zIndex: 20,
        }}
      >
